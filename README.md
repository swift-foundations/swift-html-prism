...
[![CI](https://github.com/swift-compositions/swift-html-prism/workflows/CI/badge.svg)](https://github.com/swift-compositions/swift-html-prism/actions/workflows/ci.yml)
...
```swift
dependencies: [
    .package(url: "https://github.com/swift-compositions/swift-html-prism", from: "0.1.0")
]
```
